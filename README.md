...
2. The code is for 3D-CT image segmentation task, training a model through slicing 3D images in X and Y and even Z directions and applying 2D-UNET model on the resulting slices. NUmber of slices is 10240.
